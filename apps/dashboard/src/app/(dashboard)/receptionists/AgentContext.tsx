...
export const AgentProvider: React.FC<{ children: ReactNode, agent_id: string }> = ({ children, agent_id }) => {
    ...
    return (
        <AgentContext.Provider value={{ agentResponse, isAgentError, agentError, agent_id }}>
            {children}

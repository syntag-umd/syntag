...
import { Message, MessageTypeEnum, TranscriptMessage, TranscriptMessageTypeEnum } from './lib/types/conversation.type.ts';
import vapi from './vapi.sdk.ts';
...
export function useVapi() {
  ...
  const start = async () => {
    ...
    const response = vapi.start('29b115f5-647f-449e-8651-2f7b321b114a');

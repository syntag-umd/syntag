    ...
    return (
        <div className={`w-72 h-fit bg-[color:var(--card)] text-white max-w-fit p-3 rounded-lg text-center ${className}`}>
            ...
            <div className="flex flex-col items-center gap-2">
                <Image className="rounded-full" src="/headshot.png" alt={"AI Receptionist profile picture"} width={100} height={100}/>
                <div> <span className="font-bold"> AI Receptionist </span> is ready to call </div>
                ...
                <button 
                    ...
                    onClick={() => toggleCall()}
                >
                    {callStatus == CALL_STATUS.ACTIVE ? 'End Call' : 

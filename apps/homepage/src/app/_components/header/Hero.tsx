            ...
            <div className="w-full lg:w-1/2 p-3 text-center lg:text-left">
                ...
                <div className="my-10">
                    <h2 className="font-medium text-[1.25rem] mb-5">
                        Enjoy a quieter phone and let SynTag handle all your customer calls instantly. 
                        Grow revenue and save time, so you can work on what matters most.
                    </h2>
                    <div className="bg-black text-white p-1 px-2 m-auto lg:m-0 w-fit text-nowrap rounded-full">
                        <span className="hidden sm:inline-block"> Schedule a call with us and get </span> 300 minutes of calling for free 
                    </div>
                </div>
                <div className="flex flex-row mt-4 gap-4 justify-center lg:justify-start">
                    ...
                    <Link href='https://calendly.com/vikram-from-syntag/30min'> 
                        <ActionButton className="bg-black" name="Contact Sales" arrow={false}/>
                    </Link>
                </div>
            </div>
